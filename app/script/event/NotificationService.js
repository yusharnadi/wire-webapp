...
z.event.NotificationService = class NotificationService {
  ...
  get_last_notification_id_from_db() {
    return this.storage_service.load(z.storage.StorageService.OBJECT_STORE.AMPLIFY, NOTIFICATION_SERVICE_CONFIG.PRIMARY_KEY_LAST_NOTIFICATION)
  ...
  save_last_notification_id_to_db(notification_id) {
    return this.storage_service.save(z.storage.StorageService.OBJECT_STORE.AMPLIFY, NOTIFICATION_SERVICE_CONFIG.PRIMARY_KEY_LAST_NOTIFICATION, {value: notification_id});
  }
};
