...
class z.main.App
  ...
  _setup_repositories: ->
    ...
    repository.calling             = new z.calling.CallingRepository @service.call, @service.calling, repository.client, repository.conversation, repository.media, repository.user
