...
z.calling.entities.ECallMessage = class ECallMessage {
  ...
  to_JSON() {
    ...
    if ([z.calling.enum.E_CALL_MESSAGE_TYPE.GROUP_SETUP, z.calling.enum.E_CALL_MESSAGE_TYPE.PROP_SYNC, z.calling.enum.E_CALL_MESSAGE_TYPE.SETUP, z.calling.enum.E_CALL_MESSAGE_TYPE.UPDATE].includes(this.type)) {
