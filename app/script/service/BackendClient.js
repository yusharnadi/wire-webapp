...
z.service.BackendClient = class BackendClient {
  static get CONNECTIVITY_CHECK_TRIGGER() {
    return {
      ACCESS_TOKEN_REFRESH: 'z.service.BackendClient::CONNECTIVITY_CHECK_TRIGGER.ACCESS_TOKEN_REFRESH',
      ACCESS_TOKEN_RETRIEVAL: 'z.service.BackendClient::CONNECTIVITY_CHECK_TRIGGER.ACCESS_TOKEN_RETRIEVAL',
      APP_INIT_RELOAD: 'z.service.BackendClient.CONNECTIVITY_CHECK_TRIGGER.APP_INIT_RELOAD',
      CONNECTION_REGAINED: 'z.service.BackendClient.CONNECTIVITY_CHECK_TRIGGER.CONNECTION_REGAINED',
      LOGIN_REDIRECT: 'z.service.BackendClient.CONNECTIVITY_CHECK_TRIGGER.LOGIN_REDIRECT',
      REQUEST_FAILURE: 'z.service.BackendClient.CONNECTIVITY_CHECK_TRIGGER.REQUEST_FAILURE',
      UNKNOWN: 'z.service.BackendClient.CONNECTIVITY_CHECK_TRIGGER.UNKNOWN',
    };
  }
  ...
  */
  ...
  status() {
    return $.ajax({
      timeout: BACKEND_CLIENT_CONFIG.CONNECTIVITY_CHECK.REQUEST_TIMEOUT,
      type: 'HEAD',
   ...
   * @param {z.service.BackendClient.CONNECTIVITY_CHECK_TRIGGER} [source=z.service.Client.CONNECTIVITY_CHECK_TRIGGER.UNKNOWN] - Trigger that requested connectivity check
   * @returns {Promise} Resolves once the connectivity is verified
   */
  execute_on_connectivity(source = z.service.BackendClient.CONNECTIVITY_CHECK_TRIGGER.UNKNOWN) {
      ...
      return this.status()
        ...
        .fail((jqXHR) => {
          if (jqXHR.readyState === 4) {
            ...
            this.connectivity_timeout = window.setTimeout(_check_status, BACKEND_CLIENT_CONFIG.CONNECTIVITY_CHECK.RECHECK_TIMEOUT);
          }
        });
    };
    ...
    if (!this.connectivity_timeout) {
      this.connectivity_timeout = window.setTimeout(_check_status, BACKEND_CLIENT_CONFIG.CONNECTIVITY_CHECK.INITIAL_TIMEOUT);
    }
